<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand px-4 py-3 m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
      ...
      <span class="ms-1 text-sm text-dark">Dress IT</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('admin.cities.*') ? 'active bg-gradient-dark text-white' : 'text-dark' }}"
          href="{{ route('admin.cities.index') }}">
          <i class="material-symbols-rounded opacity-5">table_view</i>
          <span class="nav-link-text ms-1">Manage Cities</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('admin.looks.*') ? 'active bg-gradient-dark text-white' : 'text-dark' }}"
          href="{{ route('admin.looks.index') }}">
          <i class="material-symbols-rounded opacity-5">table_view</i>
          <span class="nav-link-text ms-1">Manage Look</span>
        </a>
      </li>
    </ul>
