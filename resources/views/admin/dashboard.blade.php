            ...
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h4 class="mb-0">$<?php echo $data['today_payments'];?></h4>
                </div>
            ...
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h4 class="mb-0"><?php echo $data['total_users'];?></h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">Total Looks</p>
                  <h4 class="mb-0"><?php echo $data['total_looks'];?></h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
            ...
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h4 class="mb-0">$<?php echo $data['total_payments'];?></h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
                  <i class="material-symbols-rounded opacity-10">weekend</i>
                </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Dress IT</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.creative-tim.com" class="nav-link text-muted" target="_blank">Dress IT</a>
                </li>
                <li class="nav-item">
